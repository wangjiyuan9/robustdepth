...
# python vddepth/evaluate_depth.py --eval_mono --load_weights_folder /media/kieran/ODD/logs/train_all/models/weights_24 --eval_split cityscape --data_path
# /media/kieran/SSDNEW/Base-Model/data/CS_RAW --foggy
# python vddepth/evaluate_depth.py --eval_mono --load_weights_folder /media/kieran/ODD/logs/train_all_fm_gone/models/weights_best --data_path /media/kieran/SSDNEW/Base-Model/data/DrivingStereo
# --eval_split foggy
# python vddepth/evaluate_depth.py --eval_mono --load_weights_folder /media/kieran/ODD/logs/train_all/models/weights_24 --data_path /media/kieran/SSDNEW/Base-Model/data/nuScenes_RAW --eval_split
# nuScenes_test_night
...
def evaluate(opt):
    ...
    if opt.eval_split == 'cityscape':
        ...
        dataset = datasets.DRIVINGSTEREO(opt.data_path, filenames,
            384, 1280,  # encoder_dict['height'], encoder_dict['width'],
    ...
    dataloader = DataLoader(dataset, 5, shuffle=False, num_workers=6,
    ...
    with torch.no_grad():
        ...
        for data in tqdm.tqdm(dataloader):
            ...
            # save_image(input_color, f'./img/org/{n}.jpg')
            # n+=1
    ...
    elif not (opt.eval_split == "sunny" or opt.eval_split == "foggy" or opt.eval_split == "rainy" or opt.eval_split == "cloudy"):
    ...
    for i in tqdm.tqdm(range(pred_disps.shape[0])):
        ...
        elif opt.eval_split == 'rainy' or opt.eval_split == 'foggy' or opt.eval_split == 'cloudy':

            depth_path = os.path.join(opt.data_path, opt.eval_split, "depth-map-full-size", filenames[i])
